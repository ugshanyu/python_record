...
# MongoDB setup
mongo_uri = os.getenv('MONGO_URI', 'mongodb+srv://gpdt-history:tCJee3CuMdP0Fa12@chat-history.fcmptqd.mongodb.net/?retryWrites=true&w=majority&appName=chat-history')
